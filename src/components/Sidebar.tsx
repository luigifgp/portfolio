...
const SideBar = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex flex-col w-40 bg-DarkModeDark overflow-hidden gap-14">
        <div className="flex items-center justify-center h-40 shadow-zinc-900 shadow-lg mb-24 ">
          <a href="/">
            <img className="w-52" src="/svg/logo-luigi.svg" alt="logo" />
          </a>
        </div>
        ...
        {routes.map((route) => (
          <ul className="flex flex-col  ">
            <li>
              ...
              <a
                href="#wq"
                className="flex flex-row items-center justify-center transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-400 hover:text-OrangeColor"
              >
